...
public class ImageResourceIntTest {
    ...
    private static final Boolean DEFAULT_IS_WALLPAPER = false;
    private static final Boolean UPDATED_IS_WALLPAPER = true;
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image()
            .url(DEFAULT_URL)
            .isWallpaper(DEFAULT_IS_WALLPAPER);
        return image;
    }
    ...
    public void createImage() throws Exception {
        ...
        assertThat(testImage.isIsWallpaper()).isEqualTo(DEFAULT_IS_WALLPAPER);
    }
    ...
    @Test
    @Transactional
    public void checkIsWallpaperIsRequired() throws Exception {
        int databaseSizeBeforeTest = imageRepository.findAll().size();
        // set the field null
        image.setIsWallpaper(null);
    ...
    public void getAllImages() throws Exception {
        ...
        restImageMockMvc.perform(get("/api/images?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isWallpaper").value(hasItem(DEFAULT_IS_WALLPAPER.booleanValue())));
    }
    ...
    public void getImage() throws Exception {
        ...
        restImageMockMvc.perform(get("/api/images/{id}", image.getId()))
            ...
            .andExpect(jsonPath("$.isWallpaper").value(DEFAULT_IS_WALLPAPER.booleanValue()));
    }
    ...
    public void updateImage() throws Exception {
        ...
        updatedImage
            .url(UPDATED_URL)
            .isWallpaper(UPDATED_IS_WALLPAPER);
        ...
        assertThat(testImage.isIsWallpaper()).isEqualTo(UPDATED_IS_WALLPAPER);
    }
